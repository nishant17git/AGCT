document.addEventListener("DOMContentLoaded", function(){
    ...
    Project.addEventListener("click", function(){
        desc.textContent = "The registration period for the AGCT Men’s Cricket Test Championship will be announced soon. The number of participating teams will be confirmed after the registration process is complete. Once finalized, the official list of teams will be revealed, showcasing the talented squads set to compete. Each team will battle it out in the Round Robin format, striving for a spot in the highly anticipated final.";
